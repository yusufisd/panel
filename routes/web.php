...
Route::prefix('ogrenci')->middleware('auth:ogrenci')->name('ogrenci')->group(function () {
    Route::get('/cikis-yap', [OgrenciAuthController::class, 'logout'])->name('.logout');

    Route::get('/programlar',[GenelController::class,'programlar'])->name('.programlar');
    Route::get('/danismanim',[GenelController::class,'danismanim'])->name('.danismanim');
    Route::get('/basvurulacak',[GenelController::class,'basvurulacak'])->name('.basvurulacak');
    Route::get('/basvurulan',[GenelController::class,'basvurulan'])->name('.basvurulan');
    Route::get('/onaylanan',[GenelController::class,'onaylanan'])->name('.onaylanan');
    Route::get('/reddedilen',[GenelController::class,'basvurulan'])->name('.reddedilen');
    Route::get('/profil',[GenelController::class,'profil'])->name('.profil');
});
