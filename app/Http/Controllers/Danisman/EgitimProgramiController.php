...
class EgitimProgramiController extends Controller
{
    public function index()
    {
        ...
        return view('danisman.pages.egitim_programi.list',compact('data'));
    }
    ...
    {
        return view('danisman.pages.egitim_programi.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('danisman.egitim_programi.list');
    }
    ...
    public function edit($id)
    {
        ...
        return view('danisman.pages.egitim_programi.edit',compact('data'));
    }
