...
class GenelProgramController extends Controller
{
    public function index()
    {
        ...
        return view('danisman.pages.genel_program.list',compact('data'));
    }
    ...
    {
        return view('danisman.pages.genel_program.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('danisman.genel_program.list');
    }
    ...
    public function edit($id)
    {
        ...
        return view('danisman.pages.genel_program.edit',compact('data'));
    }
