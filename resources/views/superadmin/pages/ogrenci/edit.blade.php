        ...
        <div class="card">
            ...
            <div class="card-body">
                @foreach ($data as $item)
                    <form action="{{ route('ogrenci.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div onclick="deneme2()" class="eve col-md-2" id="eve_basvurulacak"
                                ...
                                <div class="eve col-md-2" id="eve_basvurulan"
                                    style="background-color: gray;border-color:brown!important;border:solid;border-radius:10px; height:50px;width:200px; margin:2%;border-width:thin">
                                    <a href="{{ route('ogrenci.guvenlik',$item->id) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="departman_id" class="form-control" id="">
                                        ...
                                        @foreach ($departman as $dep)
                                            <option {{ $item->Danisman->department_id ?? '-1' == $dep->id ? 'selected' : '' }}
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select name="uni_il_id" class="form-control" id="uni_il_id">
                                        ...
                                        @foreach ($iller as $il)
                                            <option {{ $item->uni_il_id == $il->id ? 'selected' : '' }}
                                                value="{{ $il->id }}">{{ strtoupper($il->il_name) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="program" id="program" style="display: none">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="genel_program" class="form-control" id="">
                                        ...
                                        @foreach ($genel_program as $pro)
                                            <option {{ $item->genel_program == $pro->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="egitim_programi" class="form-control" id="">
                                        ...
                                        @foreach ($egitim_programi as $prog)
                                            <option {{ $item->egitim_program_id == $prog->id ? 'selected' : '' }}
                                                value="{{ $prog->id }}">{{ $prog->name }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="akademik_program" class="form-control" id="">
                                        ...
                                        @foreach ($akademik_program as $pro)
                                            <option {{ $item->akademik_prgram_id == $pro->id ? 'selected' : '' }}
                                                value="{{ $pro->id }}">{{ $pro->name }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="dil_sinavi" class="form-control" id="">
                                        ...
                                        @foreach ($dil_sinavi as $pro)
                                            <option {{ $item->dil_sinavi_id == $pro->id ? 'selected' : '' }}
                                                value="{{ $pro->id }}">{{ $pro->name }}</option>
                                        @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="{{ $item->prosedur }}"
                                        name="prosedur" id="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control"
                                        name="email"value="{{ $item->email }}" id="">
                                </div>
                                <div class="col-md-6">
