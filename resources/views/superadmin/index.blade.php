                ...
                <div class="card-body px-0">
                    <div class="px-3" data-simplebar style="max-height: 386px;">
                        ...
                        <div class="d-flex align-items-center pb-4">
                            <div class="flex-grow-1">
                                <h5 class="font-size-15 mb-1"><a href="" class="text-dark"> {{$item->name}}</a></h5>
                            </div>
                            <div >
                        ...
                        <table class="table align-middle table-nowrap ">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <h5 class="font-size-15"><a href="" class="text-dark">{{$item->name}} {{$item->surname}}</a></h5>
                                            <span class="text-muted">{{$item->email}}</span>
                                        </div>
                                    </td>

                                    <td>
                                        <p class="mb-1"><a href="" class="text-dark">{{$item->Departman->name}}</a></p>
