    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{route('superadmin.index')}}" class="logo logo-dark">
                    <span class="logo-lg">
                        <span class="logo-txt" style="font-size10px">pluseducation</span>
                    </span>
                </a>

                <a href="{{route('superadmin.index')}}" class="logo logo-light">
                    <span class="logo-lg">
                        <span class="logo-txt" style="font-size10px">pluseducation</span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ Auth::guard('admin')->user()->username }}</span>
