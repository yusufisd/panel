        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('.borc.list')}}" key="t-buttons">BORÇ LİSTESİ</a></li>
                        <li><a href="{{route('.tahsilat.list')}}" key="t-buttons">TAHSİLAT LİSTESİ</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('danisman_muhasebe.odeme_yap')}}" data-key="t-lightbox">ÖDEME YAP</a></li>
                        <li><a href="{{route('danisman_muhasebe.odeme_list')}}" data-key="t-range-slider">TÜM ÖDEMELER</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('ekstre.add')}}" data-key="t-form-elements">EKSTRE</a></li>
                    </ul>
                </li>
