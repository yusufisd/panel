    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{route('danisman.index')}}" class="logo logo-dark">
                    <span class="logo-lg">
                        <span class="logo-txt" style="font-size10px">pluseducation</span>
                    </span>
                </a>

                <a href="{{route('danisman.index')}}" class="logo logo-light">
                    <span class="logo-lg">
                        <span class="logo-txt" style="font-size10px">pluseducation</span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end"
                    ...
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ Auth::guard('danisman')->user()->name }}
                        {{ Auth::guard('danisman')->user()->surname }}</span>
