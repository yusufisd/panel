    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" style="background-color: gray">
                <h4 class="card-title" style="color:white">BAŞVURULAN ÜNİVERSİTELER</h4>
            </div>
            <div class="card-body">
...
<?php echo $__env->make('ogrenci.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/ogrenci/pages/basvurulan.blade.php ENDPATH**/ ?>