...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('danisman.egitim_programi.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('danisman.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/danisman/pages/egitim_programi/add.blade.php ENDPATH**/ ?>