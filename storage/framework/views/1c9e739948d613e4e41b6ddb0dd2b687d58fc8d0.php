        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form action="<?php echo e(route('ogrenci.update')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="okul" id="okul" style="display: none">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select name="uni_il_id" class="form-control" id="uni_il_id">
                                        ...
                                        <?php $__currentLoopData = $iller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $il): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($item->uni_il_id == $il->id ? 'selected' : ''); ?>

                                                value="<?php echo e($il->id); ?>"><?php echo e(strtoupper($il->il_name)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <label for="">OKUL</label>
                                    <input type="text" class="form-control" name="okul" id="">
                                </div>
                                <div class="col-md-4">
                                    <label for="">SINIF</label>
                                    <input type="number" class="form-control" name="sinif" id="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="program" id="program" style="display: none">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="genel_program" class="form-control" id="">
                                        ...
                                        <?php $__currentLoopData = $genel_program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($item->genel_program == $pro->id ? 'selected' : ''); ?>

                                                value="<?php echo e($pro->id); ?>"><?php echo e($pro->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="egitim_programi" class="form-control" id="">
                                        ...
                                        <?php $__currentLoopData = $egitim_programi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($item->egitim_program_id == $prog->id ? 'selected' : ''); ?>

                                                value="<?php echo e($prog->id); ?>"><?php echo e($prog->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="akademik_program" class="form-control" id="">
                                        ...
                                        <?php $__currentLoopData = $akademik_program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($item->akademik_prgram_id == $pro->id ? 'selected' : ''); ?>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="dil_sinavi" class="form-control" id="">
                                        ...
                                        <?php $__currentLoopData = $dil_sinavi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($item->dil_sinavi_id == $pro->id ? 'selected' : ''); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo e($item->prosedur); ?>"
                                        name="prosedur" id="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control"
                                        name="email"value="<?php echo e($item->email); ?>" id="">
                                </div>
                                <div class="col-md-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/superadmin/pages/ogrenci/edit.blade.php ENDPATH**/ ?>