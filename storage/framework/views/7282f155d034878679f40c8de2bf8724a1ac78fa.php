        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background-color: brown">
                    <h4 class="card-title" style="color:white">BORÇ LİSTESİ</h4>
                </div>
                    <div class="card-body">
                        ...
                        <table id="" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <a href="<?php echo e(route('danisman.ogrenci.detay',$item->Ogrenci->id)); ?>"> 
                                            <?php echo e(strtoupper($item->Ogrenci->name)); ?> <?php echo e(strtoupper($item->Ogrenci->surname)); ?>
                                        ...
                                        <td style="width:150px">
                                            <a href="<?php echo e(route('danisman.borc.duzenle', $item->id)); ?>">
            ...
            function test(d) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "<?php echo e(route('danisman.borc.sil')); ?>/" + d;
                    }
                })
            }
        </script>
...
<?php echo $__env->make('danisman.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/danisman/pages/muhasebe/borc_listesi.blade.php ENDPATH**/ ?>