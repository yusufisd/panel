    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" style="background-color: brown">
                <h4 class="card-title" style="color:white">AKADEMİK PROGRAM DÜZENLE</h4>
            </div>
            <div class="card-body">
                
                <form action="<?php echo e(route('danisman.akademik_program.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('danisman.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/danisman/pages/akademik_program/edit.blade.php ENDPATH**/ ?>