    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" style="background-color: gray">
                <h4 class="card-title" style="color:white">AKADEMİK PROGRAM LİSTESİ</h4>
            </div>
            <div class="card-body">
               ...
               <div class="container">
                <br>
                    <div class="row">
                        <div class="col-md-6">
                            <p style="text-align:right" for="">GENEL PROGRAM: </p>
                        </div>
                        <div class="col-md-6">
                            <h4><?php echo e($ogrenci->genelProgram->name ?? '-'); ?></h4>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-md-6">
                            <p style="text-align:right" for="">EĞİTİM PROGRAMI: </p>
                        </div>
                        <div class="col-md-6">
                            <h4><?php echo e($ogrenci->egitimProgrami->name ?? '-'); ?></h4>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-md-6">
                            <p style="text-align:right" for="">AKADEMİK PROGRAM: </p>
                        </div>
                        <div class="col-md-6">
                            <h4><?php echo e($ogrenci->akademikProgram->name ?? '-'); ?></h4>
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col-md-6">
                            <p style="text-align:right" for="">DİL SINAVI : </p>
                        </div>
                        <div class="col-md-6">
                            <h4><?php echo e($ogrenci->dilSinavi->name ?? '-'); ?></h4>
                        </div>
                    </div><br>
               </div>
...
<?php echo $__env->make('ogrenci.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/ogrenci/pages/programlar.blade.php ENDPATH**/ ?>