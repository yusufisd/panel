    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header" style="background-color: brown">
                <h4 class="card-title" style="color:white">AKADEMİK PROGRAM EKLE</h4>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('danisman.akademik_program.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('danisman.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/danisman/pages/akademik_program/add.blade.php ENDPATH**/ ?>