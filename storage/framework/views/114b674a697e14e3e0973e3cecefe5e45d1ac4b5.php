            ...
            <div class="card-body">
                ...
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h4><?php echo e($danisman->name); ?> <?php echo e($danisman->surname); ?></h4>
                        </div>
                    </div><hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h4><?php echo e($danisman->phone); ?></h4>
                        </div>
                    </div><hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h4><?php echo e($danisman->Departman->name); ?></h4>
                        </div>
                    </div><br>
                </div>
...
<?php echo $__env->make('ogrenci.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/ogrenci/pages/danismanim.blade.php ENDPATH**/ ?>