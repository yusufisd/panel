                    ...
                    <table id="" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <a href="<?php echo e(route('ogrenci.detail', $item->Ogrenci->id)); ?>">
                                            <?php echo e(strtoupper($item->Ogrenci->name)); ?> <?php echo e(strtoupper($item->Ogrenci->surname)); ?>

                                        </a>
                                    </td>
                                    <td><?php echo e($item->tutar); ?> TL</td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/superadmin/pages/muhasebe/borc_listesi.blade.php ENDPATH**/ ?>