                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="ulke_id" class="form-control" id="">
                                ...
                                <option <?php echo e($data->ulke_id == $ulke->id ? 'selected' : ''); ?> value="<?php echo e($ulke->id); ?>"><?php echo e($ulke->country_name); ?></option>
...
<input type="hidden" value="<?php echo e($data->id); ?>" name="id" id="">
                        </div>
                    </div><br>
                    <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/superadmin/pages/departman/edit.blade.php ENDPATH**/ ?>