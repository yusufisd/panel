        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background-color: gray">
                    <h4 class="card-title" style="color:white">DANIŞMAN LİSTESİ</h4>
                </div>
                <div class="card-body">
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="width:100px">
                                        <a href="<?php echo e(route('danisman.edit', $item->id)); ?>">
        ...
        function test(d) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?php echo e(route('danisman.destroy')); ?>/" + d;
                }
            })
        }
    </script>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/superadmin/pages/danisman/list.blade.php ENDPATH**/ ?>