                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="<?php echo e(url('/')); ?>" class="d-block auth-logo">
                                        <img src="<?php echo e(URL::asset('assets/images/logo-sm.svg')); ?>" alt=""
                                            height="28"> <span class="logo-txt">SÜPER ADMİN</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="mt-4 pt-2" action="<?php echo e(route('superadmin.login.post')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views\superadmin\auth\login.blade.php ENDPATH**/ ?>