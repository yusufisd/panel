                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h5 style="text-align: left;width:100%">
                                                <?php echo e(strtoupper($item->Universite->uni_name)); ?></h5>
                                        </div>
                                    </div>
                            ...
                            <div class="row container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h5 style="text-align: left">
                                                <?php echo e(strtoupper($item->Fakulte->fakulte_ad)); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h5 style="text-align: left"><?php echo e(strtoupper($item->bolum)); ?></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $basvurulacak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $basvuru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($basvuru->Ulke->country_name); ?></td>
                                            <td><?php echo e($basvuru->universite); ?></td>
                                            <td><?php echo e($basvuru->bolum); ?></td>
