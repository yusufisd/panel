    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium"><?php echo e(Auth::guard('danisman')->user()->name); ?> <?php echo e(Auth::guard('danisman')->user()->surname); ?></span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item " href="<?php echo e(route('danisman.logout')); ?>"><i class="bx bx-power-off font-size-16 align-middle me-1"></i> <span key="t-logout">Çıkış Yap</span></a>
...
<?php /**PATH C:\xampp\htdocs\panel\resources\views/danisman/layouts/topbar.blade.php ENDPATH**/ ?>