                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="width:150px">
                                    <a href="<?php echo e(route('danisman.akademik_program.edit', $item->id)); ?>">
        ...
        function test(d) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?php echo e(route('danisman.akademik_program.destroy')); ?>/" + d;
                }
            })
        }
    </script>
...
<?php echo $__env->make('danisman.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\panel\resources\views/danisman/pages/akademik_program/list.blade.php ENDPATH**/ ?>